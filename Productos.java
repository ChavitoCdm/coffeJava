...
public class Productos {
	...
	public Productos(String nombre, String marca, String descripcion, Double precio, Integer stock,
			String categoria) {
	...
	public Productos(int codigo, String nombre, String marca, String descripcion, Double precio, Integer stock,
			String categoria) {
	...
	public boolean iguales(Productos p1) {
